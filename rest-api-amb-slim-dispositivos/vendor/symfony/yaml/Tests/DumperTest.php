...
class DumperTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->path = str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures';
    }
...
EOF;
    ...
    {
        $binaryData = file_get_contents(str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures/arrow.gif');
...
YAML;
    ...
    public function testDumpMultiLineStringAsScalarBlock()
    {
        ...
        $this->assertSame(file_get_contents(str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures/multiple_lines_as_literal_block.yml'), $this->dumper->dump($data, 2, 0, Yaml::DUMP_MULTI_LINE_LITERAL_BLOCK));
    }
    ...
    public function testDumpMultiLineStringAsScalarBlockWhenFirstLineHasLeadingSpace()
    {
        ...
        $this->assertSame(file_get_contents(str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures/multiple_lines_as_literal_block_leading_space_in_first_line.yml'), $this->dumper->dump($data, 2, 0, Yaml::DUMP_MULTI_LINE_LITERAL_BLOCK));
    }
