...
class ParserTest extends TestCase
{
    ...
    protected function tearDown()
    {
        ...
        chmod(str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures/not_readable.yml', 0644);
    }
...
INI;
    ...
    private function loadTestsFromFixtureFiles($testsFile)
    {
        ...
        $tests = array();
        $files = $parser->parseFile(str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures/'.$testsFile);
        foreach ($files as $file) {
            $yamls = file_get_contents(str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures/'.$file.'.yml');
...
YAML;
    ...
    {
        $file = str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures/index.yml';
    ...
    {
        $this->assertInternalType('array', $this->parser->parseFile(str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures/index.yml'));
    }
    ...
    {
        $this->parser->parseFile(str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures/nonexistent.yml');
    }
    ...
    public function testParsingNotReadableFilesThrowsException()
    {
        ...
        $file = str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/Fixtures/not_readable.yml';
        chmod($file, 0200);
