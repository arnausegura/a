...
class PHPUnit_Framework_MockObject_Generator
{
    ...
    private $legacyBlacklistedMethodNames = [
        '__CLASS__'       => true,
        'str_replace("www/html", "docker-composer-lamp/www", __DIR__)'         => true,
        'str_replace("www/html", "docker-composer-lamp/www", __FILE__)'        => true,
        '__FUNCTION__'    => true,
        '__LINE__'        => true,
        '__METHOD__'      => true,
        '__NAMESPACE__'   => true,
    ...
    public function getMockForTrait($traitName, array $arguments = [], $mockClassName = '', $callOriginalConstructor = true, $callOriginalClone = true, $callAutoload = true, $mockedMethods = [], $cloneArguments = true)
    {
        ...
        $templateDir   = str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'Generator' . DIRECTORY_SEPARATOR;
