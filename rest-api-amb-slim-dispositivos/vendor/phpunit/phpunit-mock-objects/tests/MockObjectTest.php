...
class Framework_MockObjectTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $mock = $this->getMockFromWsdl(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . '/_fixture/GoogleSearch.wsdl', 'WsdlMock');
    ...
    {
        $mock = $this->getMockFromWsdl(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . '/_fixture/GoogleSearch.wsdl', 'My\\Space\\WsdlMock');
    ...
    {
        $a = $this->getMockFromWsdl(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . '/_fixture/GoogleSearch.wsdl');
        $b = $this->getMockFromWsdl(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . '/_fixture/GoogleSearch.wsdl');
