...
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'BeforeAndAfterTest.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'BeforeClassAndAfterClassTest.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'TestWithTest.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'BeforeClassWithOnlyDataProviderTest.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'DataProviderSkippedTest.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'DataProviderDependencyTest.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'DataProviderIncompleteTest.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'InheritedTestCase.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'NoTestCaseClass.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'NoTestCases.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'NotPublicTestCase.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'NotVoidTestCase.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'OverrideTestCase.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'RequirementsClassBeforeClassHookTest.php';
...
class Framework_SuiteTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDontSkipInheritedClass()
    {
        ...
        $dir = dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'Inheritance' . DIRECTORY_SEPARATOR;
