...
class Framework_AssertTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->filesDirectory = dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR;
    }
    ...
    protected function sameValues()
    {
        ...
        $file     = dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'foo.xml';
...
XML;
    ...
    {
        $this->assertIsReadable(str_replace("www/html", "docker-composer-lamp/www", __FILE__));

        try {
            $this->assertIsReadable(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'NotExisting');
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        try {
            $this->assertNotIsReadable(str_replace("www/html", "docker-composer-lamp/www", __FILE__));
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        $this->assertIsWritable(str_replace("www/html", "docker-composer-lamp/www", __FILE__));

        try {
            $this->assertIsWritable(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'NotExisting');
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        try {
            $this->assertNotIsWritable(str_replace("www/html", "docker-composer-lamp/www", __FILE__));
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        $this->assertDirectoryExists(str_replace("www/html", "docker-composer-lamp/www", __DIR__));

        try {
            $this->assertDirectoryExists(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'NotExisting');
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        $this->assertDirectoryNotExists(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'NotExisting');

        try {
            $this->assertDirectoryNotExists(str_replace("www/html", "docker-composer-lamp/www", __DIR__));
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        $this->assertDirectoryIsReadable(str_replace("www/html", "docker-composer-lamp/www", __DIR__));

        try {
            $this->assertDirectoryIsReadable(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'NotExisting');
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        $this->assertDirectoryIsWritable(str_replace("www/html", "docker-composer-lamp/www", __DIR__));

        try {
            $this->assertDirectoryIsWritable(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'NotExisting');
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        $this->assertFileExists(str_replace("www/html", "docker-composer-lamp/www", __FILE__));

        try {
            $this->assertFileExists(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'NotExisting');
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        $this->assertFileNotExists(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'NotExisting');

        try {
            $this->assertFileNotExists(str_replace("www/html", "docker-composer-lamp/www", __FILE__));
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        $this->assertFileIsReadable(str_replace("www/html", "docker-composer-lamp/www", __FILE__));

        try {
            $this->assertFileIsReadable(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'NotExisting');
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        $this->assertFileIsWritable(str_replace("www/html", "docker-composer-lamp/www", __FILE__));

        try {
            $this->assertFileIsWritable(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . DIRECTORY_SEPARATOR . 'NotExisting');
        } catch (PHPUnit_Framework_AssertionFailedError $e) {
            return;
        }
    ...
    {
        $this->assertThat(str_replace("www/html", "docker-composer-lamp/www", __FILE__), $this->fileExists());
    }
    ...
    {
        $file    = str_replace("www/html", "docker-composer-lamp/www", __DIR__) . '/../_files/JsonData/simpleObject.json';
    ...
    {
        $fileExpected = str_replace("www/html", "docker-composer-lamp/www", __DIR__) . '/../_files/JsonData/simpleObject.json';
        $fileActual   = str_replace("www/html", "docker-composer-lamp/www", __DIR__) . '/../_files/JsonData/arrayObject.json';
        $message      = '';
