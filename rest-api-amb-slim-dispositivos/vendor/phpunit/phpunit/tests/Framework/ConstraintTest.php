...
EOF
    ...
    {
        $file = dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'ClassWithNonPublicAttributes.php';
...
EOF
    ...
    {
        $fh = fopen(str_replace("www/html", "docker-composer-lamp/www", __FILE__), 'r');
        fclose($fh);

        return [
            'open resource'     => [fopen(str_replace("www/html", "docker-composer-lamp/www", __FILE__), 'r')],
            'closed resource'   => [$fh],
        ];
    }
