...
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'NoArgTestCaseTest.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'Singleton.php';
require_once dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'Mockable.php';
