...
class Util_ConfigurationTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        $this->configuration = PHPUnit_Util_Configuration::getInstance(
            dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'configuration.xml'
        );
    }
    ...
    {
        $configurationFilename =  dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'configuration.colors.true.xml';
    ...
    {
        $configurationFilename =  dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'configuration.colors.false.xml';
        $configurationInstance = PHPUnit_Util_Configuration::getInstance($configurationFilename);
        $configurationValues   = $configurationInstance->getPHPUnitConfiguration();
    ...
    {
        $configurationFilename =  dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'configuration.colors.empty.xml';
        $configurationInstance = PHPUnit_Util_Configuration::getInstance($configurationFilename);
        $configurationValues   = $configurationInstance->getPHPUnitConfiguration();
    ...
    {
        $configurationFilename =  dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'configuration.colors.invalid.xml';
        $configurationInstance = PHPUnit_Util_Configuration::getInstance($configurationFilename);
        $configurationValues   = $configurationInstance->getPHPUnitConfiguration();
    ...
    {
        $dir         = str_replace("www/html", "docker-composer-lamp/www", __DIR__);
        ...
        $this->assertEquals(
            ...
            [
              ...
              [
                ...
                4 => null,
                5 => new stdClass,
                6 => dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'MyTestFile.php',
                7 => dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'MyRelativePath',
              ],
            ],
            [
              'class'     => 'IncludePathListener',
              'file'      => str_replace("www/html", "docker-composer-lamp/www", __FILE__),
              'arguments' => []
            ],
            [
    ...
    public function testPHPConfigurationIsReadCorrectly()
    {
        $this->assertEquals(
            ...
            'include_path' =>
            [
              dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . '.',
              '/path/to/lib'
            ],
            'ini'    => ['foo' => 'bar'],
    ...
    public function testPHPConfigurationIsHandledCorrectly()
    {
        ...
        $path = dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . '.' . PATH_SEPARATOR . '/path/to/lib';
    ...
    public function testXincludeInConfiguration()
    {
        $configurationWithXinclude = PHPUnit_Util_Configuration::getInstance(
            dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'configuration_xinclude.xml'
        );
    ...
    public function testWithEmptyConfigurations()
    {
        $emptyConfiguration = PHPUnit_Util_Configuration::getInstance(
            dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'configuration_empty.xml'
        );
    ...
    public function testGetTestSuiteNamesReturnsTheNamesIfDefined()
    {
        $configuration = PHPUnit_Util_Configuration::getInstance(
            dirname(str_replace("www/html", "docker-composer-lamp/www", __DIR__)) . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'configuration.suites.xml'
        );
