...
class ParserTest extends TestCase
{
    ...
    {
        $content = \file_get_contents(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . '/fixtures/patch.txt');
    ...
    {
        $content = \file_get_contents(str_replace("www/html", "docker-composer-lamp/www", __DIR__) . '/fixtures/patch2.txt');
