...
class SnapshotTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        require_once str_replace("www/html", "docker-composer-lamp/www", __DIR__).'/_fixture/SnapshotFunctions.php';
    ...
    public function testIncludedFiles()
    {
        ...
        $this->assertContains(str_replace("www/html", "docker-composer-lamp/www", __FILE__), $snapshot->includedFiles());
    }
